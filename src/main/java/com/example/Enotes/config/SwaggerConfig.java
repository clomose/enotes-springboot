...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        ...
        info.setTermsOfService("http://the-enotes.com");
        info.setContact(
                new Contact().email("utkarshpant1090@gmail.com").name("Utkarsh Pant").url("http://the-enotes.com/contact"));
        info.setLicense(new License().name("Enotes 1.0").url("http://the-enotes.com"));
